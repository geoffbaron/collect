...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Work order tracking with priority & status",
      "Preventive maintenance schedules with overdue alerts",
      "Capital asset register (install dates, warranties, condition)",
      "Portfolio-wide operations dashboard",
      "Billed directly — no app store required",
      "Dedicated onboarding for your sites",
      "Public REST API (OpenAPI) for custom integrations",
      "PM-software integrations: Buildium available now; Yardi, AppFolio & RealPage by request",
      "SSO & audit log (roadmap)",
    ],
